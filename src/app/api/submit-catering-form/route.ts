...
export async function POST(req: Request) {
  try {
        ...
        <table align="center" width="600" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="text-align: center; padding: 30px 20px; background-color: #00282a;">
              ...
              <h2 style="color: #ffffff; margin: 10px 0 0; font-size: 22px; font-weight: 600;">New Catering Request</h2>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 30px 40px;">
              ...
              <p style="font-size: 15px; color: #00282a; margin-bottom: 25px;">
                You’ve received a new catering request. Here are the details:
              </p>
    ...
    // === 6️⃣ Send Email ===
    const mailOptions = {
      from: `"Catering Request" <${process.env.ICLOUD_USER}>`,
