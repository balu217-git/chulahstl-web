...
export default function HeroContainer({
  ...
  return (
    <section className="hero bg-brand-orange text-center text-white d-flex align-items-center justify-content-center">
      <div className="container">
        <h1 className="display-6 fw-semibold text-white mb-4">{title}</h1>
        {heroImage && (
          <Image
